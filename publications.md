...
### Conference
1. Leveraging Gloss Knowledge in Neural Word Sense Disambiguation by Hierarchical Co-Attention
<br>Fuli Luo, **Tianyu Liu**, Zexue He, Qiaolin Xia, Baobao Chang and Zhifang Sui
<br>*EMNLP2018* (To appear)
...
4. Table-to-text Generation by Structure-aware Seq2seq Learning
...
6. Large-scale Simple Question Generation by Template-based Seq2seq Learning
...
7. Affinity-Preserving Random Walk for Multi-Document Summarization
...
8. Order-Planning Neural Text Generation From Structured Data
...
9. Encoding Temporal Information for Time-Aware Link Prediction
...
10. Towards Time-Aware Knowledge Graph Completion
